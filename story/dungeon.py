...
def dungeon1(skill, efficiency, hero):
    ...
    time.sleep(2)
    print('Существо намало внезамно, вы в последний момент увернулись от его острых, как бритва, когтей')
    monster_power1 = 6
    if skill['intel']>5:
        print(f'Вы оцениваете силу монстра, она равна {monster_power1}')
    while True:
        ...
        if chouse1_d1 == 1:
            ...
            if efficiency >= monster_power1:
                ...
                while True:
                    print('Монстр делает молнеиносный выпад')
            ...
            if skill['dexterity']<4:
                ...
                print('Вы выбигаете из комнаты и плотно закрываете за собой дверь. Ещё бы чуть- чуть и монстр бы выс схватил')
                return None
